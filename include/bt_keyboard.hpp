...
private:
  ...
  static std::map<std::pair<esp_hidh_dev_t *, uint16_t>, hid_report_keyboard> keyboard_reports;
  ...
  void push_key(uint8_t *keys, uint8_t size, std::pair<esp_hidh_dev_t *, uint16_t> *key_pair = nullptr);
